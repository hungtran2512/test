...
# Bước 1: Chụp ảnh từ camera IP
camera_ip_url = "rtsp://hung:Zaq!12345@nongdanonlnine.ddns.net:554/cam/realmonitor?channel=6&subtype=0"
...
if ret:
    ...
    print("Không thể chụp ảnh từ camera IP.")
camera.release()

# Bước 2: Tải ảnh từ GitHub về máy khi cần
image_url = f"https://raw.githubusercontent.com/hungtran2512/test/main/{image_name}"
